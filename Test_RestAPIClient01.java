...
public class Test_RestAPIClient01 {
	// instance of VirustotalResponse goes here
	...
	public static void main(String[] args) {
			Test_RestAPIClient01 client = new Test_RestAPIClient01();
			try{
				...
				// test hash is 99017f6eebbac24f351415dd410d522d
			     ...
			     VirustotalResponse vtr = new VirustotalResponse( client.responsecode, client.message, client.verbosemsg, client.resource,
						 client.scanid, client.md5, client.sha1, client.sha256, client.scandate, client.permalink, client.positive,
						 client.total, client.percent, client.instant, client.avs);
			     ...
			     System.out.println(vtr.toString());
			        ...
			        System.out.println("Last scan was " + TimeDifference.c.getYears() + " years, " + TimeDifference.c.getDays()+ " days, "+TimeDifference.hr+ " hours, "+TimeDifference.mn+ " minutes ago." + "\n");
